...
2. [PolicyReport CRDs](https://github.com/kubernetes-sigs/wg-policy-prototypes/tree/master/policy-report/crd/v1alpha2) are installed in your Cluster, they will be installed via the Helm Chart (unless passing `--skip-crds` to `helm`).
